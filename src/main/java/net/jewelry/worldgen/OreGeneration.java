...
//    }
    ...
    public static final RegistryKey<PlacedFeature> GEM_VEIN_PLACED_KEY = RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(JewelryMod.ID, "gem_vein_placed"));
