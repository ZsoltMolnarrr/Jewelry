...
/// injector stays null and the jewelry shop is only placed through the data-driven paths that ship in
/// `resources/data/jewelry` (Lithostitched worldgen modifiers).
